...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Library ManageConnectionString %>" SelectCommand="SELECT * FROM [Addstudent]"></asp:SqlDataSource>
    </form>
