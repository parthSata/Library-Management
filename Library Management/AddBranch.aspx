        ...
        <div class="p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="flex items-center justify-between mt-8">
                    <asp:Button ID="Add_NewBranch" class="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10" runat="server" Text="Add Branch" />
                </div>
            </div>
        </div>
    </form>
