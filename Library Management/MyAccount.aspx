            ...
            <asp:View ID="View2" runat="server">
                <section class="text-gray-400 bg-white-900 body-font overflow-hidden">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="lg:w-2/3 mx-auto flex flex-wrap justify-center items-center">

                            <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Image") %>' class=" w-80 h-80  rounded:sm lg:w-80 lg:h-auto h-64 object-cover object-center " />
