...
namespace Library_Management
{
    public partial class AddBook : System.Web.UI.Page
    {
        ...
        {
            if (text_BookName.Text != "" && text_Detail.Text != "" && text_Author.Text != "" && text_Publication.Text != "" && text_Branch.Text != "" && text_Price.Text != "" && text_Quantity.Text != "" && text_Available.Text != ""  && FileUpload1.FileName != "" && text_Entry.Text != "" )
            {
                ...
                if (fileExtension == ".png" || fileExtension == ".jpg")
                {
                    ...
                    string sql = "insert into AddBook values('" + text_BookName.Text + "','" + text_Detail.Text + "','" + text_Author.Text + "','" + text_Publication.SelectedValue + "','" + text_Branch.Text + "','" text_Entry.Text+ "','"+ FileUpload1.FileName + "')";
