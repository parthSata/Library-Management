...
<%--                    <asp:RadioButton ID="RadioButton1" class="w-full shadow-inner bg-gray-100 rounded-lg placeholder-black text-2xl p-4 border-none block mt-1 w-full" runat="server" Text="Male" />--%>
                ...
                <div class="mt-4">
                    ...
                    <asp:TextBox ID="TextBox6" runat="server" type="date" autofocus="autofocus" class="w-full shadow-inner bg-gray-100 rounded-lg placeholder-black text-2xl p-4 border-none block mt-1 w-full"></asp:TextBox>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <asp:TextBox ID="TextBox7" runat="server" autofocus="autofocus" class="w-full shadow-inner bg-gray-100 rounded-lg placeholder-black text-2xl p-4 border-none block mt-1 w-full"></asp:TextBox>
                </div>

                <div class="mt-4">
                    <label class="block font-semibold" for="password">Password :</label>
                    <asp:TextBox ID="TextBox8" runat="server" autofocus="autofocus" class="w-full shadow-inner bg-gray-100 rounded-lg placeholder-black text-2xl p-4 border-none block mt-1 w-full"></asp:TextBox>
                </div>

                <div class="flex items-center justify-between mt-8">
                    <asp:Button ID="Add_NewStudent" runat="server" class="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10" Text="Add Student" />
